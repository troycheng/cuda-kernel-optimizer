...
[V2.5 evidence automation reference](https://github.com/troycheng/cuda-kernel-optimizer/blob/main/skills/cuda-kernel-optimizer/references/evidence_automation.md).
