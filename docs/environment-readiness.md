...
For the exact installed protocol, see the [environment readiness reference](https://github.com/troycheng/cuda-kernel-optimizer/blob/v1.6.1/skills/cuda-kernel-optimizer/references/environment_readiness.md).
