...
Exact commands and prerequisites are maintained in the [RTX 5090 test guide](https://github.com/troycheng/cuda-kernel-optimizer/blob/v1.6.0/tests/gpu/sm120/README.md). Workload-specific outcomes belong in [Case studies](case-studies.md).
