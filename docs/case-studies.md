...
- [MXFP6 SM120 exact dispatch and p99 TPOT](case-mxfp6-sm120-tail-latency.md): a small real serving example where two shape-level kernel gains produced a stable p99 TPOT improvement without a material throughput gain.
