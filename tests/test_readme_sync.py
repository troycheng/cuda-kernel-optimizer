...
class ReadmeSyncTests(unittest.TestCase):
    ...
    def test_readmes_explain_v1_3_evidence_bound_knowledge(self) -> None:
        for marker in (
            ...
            "精确 SM 和当前本地身份",
            "项目 evidence adapter 输出的版本化语义",
            "不代表内置了原始 profiler 报告解析器",
            "历史收益数字",
        ...
        for marker in (
            ...
            "versioned semantics emitted by project evidence adapters",
            "does not mean that raw profiler report parsers are bundled",
